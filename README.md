...
<img src="https://readme-typing-svg.demolab.com/?font=Fira+Code&weight=600&size=22&duration=3000&pause=1000&color=cf99b0&center=true&vCenter=true&width=650&height=50&lines=B.Tech+CSE+Student+%40+JIET+Jodhpur;App+%26+Full-Stack+Developer;Building+Nexora+-+Mentorship+Platform;GSSoC+Project+Admin+%26+Contributor" alt="Typing SVG" />

<br/>

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/aavdhesh)
[![Twitter](https://img.shields.io/badge/Twitter-1DA1F2?style=for-the-badge&logo=twitter&logoColor=white)](https://x.com/Itzzavdheshh)
[![Discord](https://img.shields.io/badge/Discord-5865F2?style=for-the-badge&logo=discord&logoColor=white)](https://discord.com/users/1385290408698839223)
[![Gmail](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:aavdhesh.dadhich@gmail.com)

<!-- ⬆️ replace YOUR_TWITTER_HANDLE and YOUR_DISCORD_ID with your real ones -->
...
- 🎓 3rd Year B.Tech CSE student at **JIET Jodhpur**
- 📱 Focused on **App Development** & **Full-Stack Development**
- 🛠️ Currently building **[Nexora](https://nexora-avdhesh.vercel.app/)** — a mentorship-booking capstone platform
- 🌱 Self-taught across Java, Kotlin, Android, React/Next.js, Node.js, Flutter, and Web3 basics
- 🤝 Contributor & Project Admin across **GSSoC, NSOC, SSOC, and ELUSOC**
- 🚀 Fun fact: I've triaged 49+ open pull requests in a single repo without losing my sanity (mostly)
- 📫 Reach me at **aavdhesh.dadhich@gmail.com**
...
- Led a 26-file migration of VoiceForge's TTS engine from ElevenLabs to Chatterbox as a single large PR
- Triaged and categorized ~49 open pull requests across an open-source repo by conflict risk
- Built GitHub Actions workflows to guard against improper merges and self-applied labels
...
My capstone project — a full mentorship-booking platform with real-time notifications, booking management, and role-based dashboards.

`React` `Vite` `Tailwind` `Express` `Supabase` `PostgreSQL`

🔗 [Live Demo](https://nexora-avdhesh.vercel.app/) · [Repository](https://github.com/Itzzavdheshh/NEXORA)

---

### 🔊 [VoiceForge](https://github.com/itzzavdhesh/VoiceForge) — Open Source TTS Platform
A GSSoC open-source project I help admin — migrated its text-to-speech engine and manage contributor workflows.
...
Lets a guest or AI agent join a host's live Chrome tab as a ghost collaborator — with cursors, annotations, and permissioned actions.

`React` `Vite` `Tailwind` `Node.js` `Chrome MV3`

🔗 [Live Demo](https://tabtwinwebapp-production.up.railway.app/) · [Repository](https://github.com/itzzavdhesh/TabTwin)

<br/>

## 📊 GitHub Analytics

<img src="assets/metrics-stats.svg" width="100%" alt="Activity and language stats" />
